...
public class ShadersRender
{
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage, float offset)
    {
        ...
        else
        {
            ...
            int i = 240;
            worldrenderer.pos(x, y + (double)offset, z + 1.0D).color4f(f1, f2, f3, 1.0F).tex((double)(f4 + f6), (double)(f4 + f6)).func_181671_a(i, i).endVertex();
            worldrenderer.pos(x + 1.0D, y + (double)offset, z + 1.0D).color4f(f1, f2, f3, 1.0F).tex((double)(f4 + f6), (double)(f5 + f6)).func_181671_a(i, i).endVertex();
            worldrenderer.pos(x + 1.0D, y + (double)offset, z).color4f(f1, f2, f3, 1.0F).tex((double)(f5 + f6), (double)(f5 + f6)).func_181671_a(i, i).endVertex();
            worldrenderer.pos(x, y + (double)offset, z).color4f(f1, f2, f3, 1.0F).tex((double)(f5 + f6), (double)(f4 + f6)).func_181671_a(i, i).endVertex();
            tessellator.draw();
