...
public class CustomLoadingScreen
{
    ...
    public void drawBackground(int width, int height)
    {
        ...
        worldrenderer.pos(0.0D, (double)height, 0.0D).tex(d3, d4 + d2).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos((double)width, (double)height, 0.0D).tex(d3 + d1, d4 + d2).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos((double)width, 0.0D, 0.0D).tex(d3 + d1, d4).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(d3, d4).color4i(255, 255, 255, 255).endVertex();
        tessellator.draw();
    }
}
