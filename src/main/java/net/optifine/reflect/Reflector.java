...
public class Reflector
{
    ...
    public static ReflectorClass ExtendedBlockState = new ReflectorClass("net.minecraftforge.forge.property.ExtendedBlockState");
    ...
    public static ReflectorClass IColoredBakedQuad = new ReflectorClass("net.minecraftforge.forge.model.IColoredBakedQuad");
    public static ReflectorClass IExtendedBlockState = new ReflectorClass("net.minecraftforge.forge.property.IExtendedBlockState");
    public static ReflectorMethod IExtendedBlockState_getClean = new ReflectorMethod(IExtendedBlockState, "getClean");
    public static ReflectorClass IModel = new ReflectorClass("net.minecraftforge.forge.model.IModel");
    ...
    public static ReflectorClass LightUtil = new ReflectorClass("net.minecraftforge.forge.model.pipeline.LightUtil");
    ...
    public static ReflectorClass ModelLoader = new ReflectorClass("net.minecraftforge.forge.model.ModelLoader");
    ...
    public static ReflectorClass ModelLoader_VanillaLoader = new ReflectorClass("net.minecraftforge.forge.model.ModelLoader$VanillaLoader", true);
