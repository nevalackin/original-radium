...
public class RenderDragon extends RenderLiving<EntityDragon>
{
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
        ...
        for (int j = 0; j <= 8; ++j)
        {
            ...
            worldrenderer.pos((double)(f9 * 0.2F), (double)(f10 * 0.2F), 0.0D).tex((double)f11, (double)f8).color4i(0, 0, 0, 255).endVertex();
            worldrenderer.pos((double)f9, (double)f10, (double)f6).tex((double)f11, (double)f7).color4i(255, 255, 255, 255).endVertex();
        }
