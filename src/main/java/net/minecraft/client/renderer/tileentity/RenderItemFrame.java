        ...
        if (Minecraft.isGuiEnabled() && entity.getDisplayedItem() != null && entity.getDisplayedItem().hasDisplayName() && this.renderManager.pointedEntity == entity)
        {
            ...
            if (d0 < (double)(f2 * f2))
            {
                ...
                if (entity.isSneaking())
                {
                    ...
                    worldrenderer.pos((double)(-i - 1), -1.0D, 0.0D).color4f(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                    worldrenderer.pos((double)(-i - 1), 8.0D, 0.0D).color4f(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                    worldrenderer.pos((double)(i + 1), 8.0D, 0.0D).color4f(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                    worldrenderer.pos((double)(i + 1), -1.0D, 0.0D).color4f(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                    tessellator.draw();
