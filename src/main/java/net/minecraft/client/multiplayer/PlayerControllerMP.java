...
public class PlayerControllerMP {
    ...
    public boolean sendUseItem(EntityPlayer playerIn, World worldIn, ItemStack itemStackIn) {
        return this.sendUseItem(playerIn, worldIn, itemStackIn, new C08PacketPlayerBlockPlacement(playerIn.inventory.getCurrentItem()));
    }

    /**
     * Notifies the server of things like consuming food, etc...
     */
    public boolean sendUseItem(EntityPlayer playerIn, World worldIn, ItemStack itemStackIn, C08PacketPlayerBlockPlacement packetPlayerBlockPlacement) {
        if (this.currentGameType == WorldSettings.GameType.SPECTATOR) {
            return false;
        } else {
            this.syncCurrentPlayItem();
            this.netClientHandler.sendPacket(packetPlayerBlockPlacement);
