            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (flag)
                {
                    ...
                    else
                    {
                        ...
                        worldrenderer.pos(0.0D, (double)l, 0.0D).tex(0.0D, (double)((float)l / f)).color4i(64, 64, 64, 255).endVertex();
                        worldrenderer.pos((double)k, (double)l, 0.0D).tex((double)((float)k / f), (double)((float)l / f)).color4i(64, 64, 64, 255).endVertex();
                        worldrenderer.pos((double)k, 0.0D, 0.0D).tex((double)((float)k / f), 0.0D).color4i(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, 0.0D).color4i(64, 64, 64, 255).endVertex();
                        tessellator.draw();
                    }
                    ...
                    if (progress >= 0)
                    {
                        ...
                        worldrenderer.pos((double)j1, (double)k1, 0.0D).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)j1, (double)(k1 + i1), 0.0D).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)(j1 + l1), (double)(k1 + i1), 0.0D).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)(j1 + l1), (double)k1, 0.0D).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos((double)j1, (double)k1, 0.0D).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)j1, (double)(k1 + i1), 0.0D).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)(j1 + progress), (double)(k1 + i1), 0.0D).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos((double)(j1 + progress), (double)k1, 0.0D).color4i(128, 255, 128, 255).endVertex();
                        tessellator.draw();
