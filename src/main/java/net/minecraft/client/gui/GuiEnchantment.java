...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        for (int l = 0; l < 3; ++l)
        {
            ...
            if (l1 == 0)
            {
                Gui.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
            }
            else
            {
                String s1 = "" + l1;
                ...
                {
                    Gui.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
                    Gui.drawTexturedModalRect(i1 + 1, j + 15 + 19 * l, 16 * l, 239, 16, 16);
                ...
                else
                {
                    ...
                    {
                        Gui.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 204, 108, 19);
                        i2 = 16777088;
                    }
                    else
                    {
                        Gui.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 166, 108, 19);
                    }

                    Gui.drawTexturedModalRect(i1 + 1, j + 15 + 19 * l, 16 * l, 223, 16, 16);
