...
public class DataWatcher
{
    ...
    public void updateWatchedObjectsFromList(List<DataWatcher.WatchableObject> watchableObjects)
    {
        this.lock.writeLock().lock();
        ...
        for (DataWatcher.WatchableObject watchableObject : watchableObjects)
        {
            ...
            DataWatcher.WatchableObject datawatcher$watchableobject1 = this.watchedObjects.get(id);
